package com.base.utils.json;


/**
 * Created by aa on 2015/3/16.
 */
...
public class ResouseJsonHelper {

    public static JSONArray getJsonArrayFromResource( int resourceId) throws JSONException, IOException {
        InputStream is = Resources.getSystem().openRawResource(resourceId);
        return new JSONArray(getStringFromInputStream(is));
    }

    public static JSONObject getJsonObjectFromResource( int resourceId) throws JSONException, IOException {
        InputStream is = Resources.getSystem().openRawResource(resourceId);
