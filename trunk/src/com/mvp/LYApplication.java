...
public class LYApplication extends FrontiaApplication {

    Process process = null;

    DataOutputStream os = null;

    private static LYApplication mInstance = null;
...
//        mManager.notify(0, notification);
    ...
    public static void initImageLoader(Context context) {
        ...
        // method.
        Rect screenrect = getScreenRect(LYApplication.getInstance());
     ...
     * @param activity
     */
    public static Rect getScreenRect(LYApplication activity) {
    ...
    public void onLowMemory() {
        System.gc();
        Toast.makeText(LYApplication.this, "内存不足了，清理内存后再打开,好不好？", Toast.LENGTH_SHORT).show();
        super.onLowMemory();
    }
