...
/**
 * Created by weizongwei on 15-12-10.
 */
...
public class SlideSwitch extends View {
    ...
    public SlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        color_theme = a.getColor(R.styleable.SlideSwitch_bgColor,
                DEFAULT_COLOR_THEME);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (shape == SHAPE_RECT) {
            ...
            // draw circle
            int bkradius=backRect.height() / 2+RIM_SIZE/3;
            int radius = backRect.height() / 2 - RIM_SIZE;
            //先画关闭背景
            paint.setColor(Color.argb(255,240,240,240));
            paint.setShadowLayer(15,50, 50, Color.GRAY);
            backCircleRect.set(backRect);
            canvas.drawRoundRect(backCircleRect, bkradius, bkradius, paint);
        ...
        toDestAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (toRight) {
                    isOpen = true;
                    if (listener != null)
                        listener.onCheckChanged(SlideSwitch.this, isOpen);
