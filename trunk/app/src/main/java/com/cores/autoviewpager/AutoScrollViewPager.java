...
public class AutoScrollViewPager extends ViewPager {
     ...
     * 设置数据
     */
    public void setPhotoData(final ArrayList<HomePhotoModel> photolist) {
        if (photolist == null || photolist.size() == 0)
            return;
        List<View> advPics = new ArrayList<View>();
        for (int i = 0; i < photolist.size(); i++) {
            final HomePhotoModel pn = photolist.get(i);
            ...
            GlideLoderUtils.display(img, pn.advertisementPath);
            ...
            img.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (pn.advertisementType == 1) {
//                        Intent intent = new Intent(context, AdvertiseActivity.class);
//                        intent.putExtra("linkurl", photolist.get(finalI).adUrl);
//                        intent.putExtra("title", photolist.get(finalI).advertisementName);
