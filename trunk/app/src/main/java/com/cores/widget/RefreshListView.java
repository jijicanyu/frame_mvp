 ...
 * @author mrsimple
 */
public class RefreshListView extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
     ...
     * 是否存在更多数据
     */
    private boolean isHaseOther=true;
    ...
    private boolean canLoad() {
        return isBottom() && !isLoading && isPullUp()&&isHaseOther;
    }
     ...
     * @param haseOther
     */
    public void setHaseOther(boolean haseOther)
    {
        isHaseOther=haseOther;
    }
